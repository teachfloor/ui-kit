    ...
    <SimpleGrid>
      ...
      <Box w={730} h={250}>
        <AreaChart
          ...
          x="date"
          y={[
            { value: 'sold', label: 'Sold', formatter: (val) => `$${val}` },
            { value: 'region', label: 'Region', formatter: (val) => `${val} units`}
          ]}
        />
      </Box>
    </SimpleGrid>
...
export const Usage = AreaChartTemplate.bind({})
